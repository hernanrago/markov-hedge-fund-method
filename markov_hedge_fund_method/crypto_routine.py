...
def main() -> int:
    ...
    parser.add_argument("--tickers", default="BTC-USD,ETH-USD,SOL-USD,BNB-USD,XRP-USD,DOGE-USD,LINK-USD,TON-USD,SUI-USD,PEPE-USD,SHIB-USD,ADA-USD,AVAX-USD,DOT-USD,NEAR-USD,UNI-USD,POL-USD,LTC-USD,FET-USD,APT-USD,OP-USD,ARB-USD,INJ-USD,TIA-USD,SEI-USD,WIF-USD,JUP-USD,BONK-USD,ENA-USD,STRK-USD")
